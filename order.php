...
function getStatusInfo($status, $order, $currency_from = null, $currency_to = null)
{
    $statuses = [
        ...
        'suspended' => [
            ...
            'text' => 'Причина: Требуется дополнительная информация, обратитесь в <a style="color:rgb(0, 89, 255);" href="https://t.me/omgswift_support">службу поддержки</a>.',
        ...
        'deleted' => [
            'title' => 'Время истекло',
            'text' => 'Созданная вами заявка не была оплачена. По всем вопросам обращайтесь в нашу <a style="color:rgb(0, 89, 255);" href="https://t.me/omgswift_support">службу поддержки</a>.',
            'show_support_button' => true
        ]
    ];
...
<body cz-shortcut-listen="true">
    <div id="__nuxt"><!---->
        <div id="__layout">
            ...
            О сервисе
          </a></li> <li class="only-mobile"><a href="https://t.me/omgswift_support">
            Поддержка
          </a></li> <!----><!----><!----><!----><!----></ul></nav> <div class="right-block"> <div><div class="registration"><ul><li><a href="https://t.me/omgswift_support" class="btn-round btn-round-blue 1">
                Поддержка
