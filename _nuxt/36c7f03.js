  ...
  [1],
  {
    511: function (e, t, n) {
      ...
      var o = n(5),
        r = n(201);
      o(
        { target: "String", proto: !0, forced: n(202)("small") },
        {
          small: function () {
            return r(this, "small", "", "");
          },
    ...
    556: function (e, t, n) {
      ...
      ((component = n(614)).name = "dropzone"),
        ...
        (component.render = function (e) {
          var t = this._self,
            n = this.$slots.default && this.$slots.default.length,
            o =
              "" === this.useCustomSlot || !0 === this.useCustomSlot || n
                ? [e("div", { staticClass: "dz-message" }, this.$slots.default)]
                : this.$slots.default,
            r = !1 !== this.$props.includeStyling;
          return e(
            "div",
            {
              props: t.props,
              attrs: {
                class: r ? "vue-dropzone dropzone" : "",
                id: t.id || "",
              },
              ref: "dropzoneElement",
            },
    ...
    557: function (e, t, n) {
      ...
      (0, n(42).default)("1816d293", content, !0, { sourceMap: !1 });
    },
    614: function (e, t, n) {
      e.exports = (function () {
        "use strict";
          ...
          t =
            ((function (e) {
                ...
                r = (function (e) {
                  function r(e, t) {
                    ...
                    if (
                      ((s.element = e),
                      (s.version = r.version),
                      (s.defaultOptions.previewTemplate =
                        s.defaultOptions.previewTemplate.replace(/\n*/g, "")),
                      (s.clickableElements = []),
                      (s.listeners = []),
                      (s.files = []),
                    ...
                    if (
                      ...
                      return (l = s.options.fallback.call(s)), i(s, l);
                    if (
                      (null == s.options.url &&
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            if (this.getActiveFiles().length) {
                              for (
                                var n = 0, o = (o = this.getActiveFiles());
                                !(n >= o.length);

                              ) {
                                var r = o[n++];
                                (t += r.upload.bytesSent),
                                  (i += r.upload.total);
                              }
                              e = (100 * t) / i;
                            } else e = 100;
                        ...
                        },
                        {
                          ...
                          value: function () {
                            for (
                              ...
                              var n,
                                o = t[i];
                              if ((n = e(this.element.getElementsByTagName(o))))
                                return n;
                            }
                          },
                        },
                          ...
                          value: function (e) {
                            ...
                            if (e > 0) {
                              for (
                                ...
                                if (
                                  e >=
                                  Math.pow(this.options.filesizeBase, 4 - o) /
                                    10
                                ) {
                                  (t =
                                    e /
                              ...
                              for (
                                ...
                                (r = s.webkitGetAsEntry())
                                  ? r.isFile
                                    ...
                                    : r.isDirectory
                                    ? i.push(
                                        t._addFilesFromDirectory(r, r.name)
                                      )
                                    : i.push(void 0)
                                  : null == s.getAsFile ||
                                    ...
                                    switch (
                                      ...
                                      case 6:
                                        c.rotate(0.5 * Math.PI),
                                          c.translate(0, -d.width);
                                        break;
                                      case 7:
                                        c.rotate(0.5 * Math.PI),
                                          c.translate(d.height, -d.width),
                                          c.scale(-1, 1);
                                        break;
                                      case 8:
                                        c.rotate(-0.5 * Math.PI),
                                          c.translate(-d.height, 0);
                                    }
                                    l(
                                      c,
                                      u,
                                  ...
                                  ((n.upload.finishedChunkUpload = function (
                                    ...
                                    for (
                                      ...
                                      if (void 0 === n.upload.chunks[a])
                                        return s();
                                      n.upload.chunks[a].status !== r.SUCCESS &&
                                        (o = !1);
                                    }
                                    o &&
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            n.open(a, l, !0),
                              ...
                              ((null != n.upload ? n.upload : n).onprogress =
                                function (t) {
                ...
                (r.isBrowserSupported = function () {
                  ...
                  if (
                    ...
                    if ("classList" in document.createElement("a"))
                      for (
                        var t = 0, i = (i = r.blacklistedBrowsers);
                        !(t >= i.length);
              ...
              (r.createElement = function (e) {
                  ...
                  if (e instanceof Array) {
                    ...
                    try {
                      for (var o = 0, r = (r = e); !(o >= r.length); )
                        (i = r[o++]), n.push(this.getElement(i, t));
                    } catch (e) {
                      n = null;
                    }
                ...
                null !== e ? (e.exports = r) : (window.Dropzone = r),
                (r.ADDED = "added"),
                (r.QUEUED = "queued"),
                (r.ACCEPTED = r.QUEUED),
                ...
                (r.ERROR = "error"),
                (r.SUCCESS = "success");
              var l = function (e, t, i, n, o, r, s, a, l, u) {
                  var d = (function (e) {
                    e.naturalWidth;
                    ...
                    n.drawImage(e, 0, 0);
                    for (
                      var o = n.getImageData(1, 0, 1, t).data,
                        r = 0,
                        s = t,
                        a = t;
                      a > r;
                  ...
                  return e.drawImage(t, i, n, o, r, s, a, l, u / d);
                },
                u = (function () {
                  function e() {
                    n(this, e);
                  ...
                  var i = !1,
                    ...
                    u = function n(r) {
                      if (
                        ...
                        return (
                          ("load" === r.type ? e : o)[a](l + r.type, n, !1),
                  ...
                  [
                    this.useCustomSlot
                      ? t(
                          ...
                          [
                            this._t("default", [
                              this._v("Drop files here to upload"),
                            ]),
                          ],
                          2
                        )
                ...
                this.dropzone.on("thumbnail", function (t, i) {
                  ...
                  this.dropzone.on("removedfile", function (t) {
                    e.$emit("vdropzone-removed-file", t),
                      t.manuallyAdded &&
                        null !== e.dropzone.options.maxFiles &&
                        e.dropzone.options.maxFiles++;
                  }),
                  this.dropzone.on("success", function (t, i) {
                    if ((e.$emit("vdropzone-success", t, i), e.isS3)) {
                      ...
                      e.wasQueueAutoProcess &&
                        e.setOption("autoProcessQueue", !1);
                    }
                  }),
                ...
                manuallyAddFile: function (e, t) {
                  ...
                  if (
                    ...
                    this.dropzone.options.createImageThumbnails &&
                      ...
                      e.size <=
                        1024 *
                          this.dropzone.options.maxThumbnailFilesize *
                          1024)
                  ) {
